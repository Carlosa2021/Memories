      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <Link
            ...
            target="_blank"
            aria-label="Twitter"
            className="hover:text-blue-400 transition-all duration-300 h-8 w-8 flex items-center justify-center hover:scale-110"
          >
          ...
          <Link
            ...
            target="_blank"
            aria-label="Discord"
            className="hover:text-indigo-300 transition-all duration-300 h-8 w-8 flex items-center justify-center hover:scale-110"
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <Link
            ...
            target="_blank"
            aria-label="GitHub"
            className="hover:text-gray-300 transition-all duration-300 h-8 w-8 flex items-center justify-center hover:scale-110"
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
